...
allow(/^gates\/(_lib|_run|local|perf|ping|repo|test)\.ts$/, 6000);
allow(/^gates\/windows\/[a-z]+\/[a-z0-9_]+\.bend$/, 16000);
allow(/^tests\/[a-z]+\/([a-z0-9-]+\/)?[a-z0-9_]+\.bend$/, 16000);
allow(/^tests\/[a-z]+\/[a-z0-9_]+\.(c|js)$/, 8000);
allow(/^tools\/[a-z-]+\.test\.ts$/, 4000);
